    ...
    <footer className="bg-charcoal text-cream mt-24">
      <div className="container mx-auto px-6 py-16 grid md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="text-xs uppercase tracking-[0.3em] text-gold mt-1">Neapolitan Pizza</p>
          <p className="mt-6 text-cream/70 max-w-md leading-relaxed">
            Prawdziwa neapolitańska pizza w sercu Wałbrzycha. Wypiekana w piecu opalanym drewnem,
            ze składnikami prosto z Włoch.
          </p>
          <div className="flex items-center gap-3 mt-6">
            ...
            <div>
              ...
              <p className="text-xs text-cream/60">1988 opinii w Google</p>
            </div>
          </div>
        </div>

        <div>
          <h4 className="font-display text-lg mb-4 text-gold">Kontakt</h4>
        ...
        <div>
          <h4 className="font-display text-lg mb-4 text-gold">Godziny otwarcia</h4>
          <ul className="space-y-2 text-sm text-cream/80">
            <li className="flex items-center gap-2"><Clock className="w-4 h-4 text-gold" /> Pon – Czw: 13:00 – 22:00</li>
            <li className="ml-6">Pt – Sob: 13:00 – 23:00</li>
            <li className="ml-6">Niedziela: 13:00 – 22:00</li>
          </ul>
          <p className="mt-4 text-xs text-cream/50">40–60 zł za osobę</p>
        </div>
      </div>
      ...
      <div className="border-t border-cream/10">
        <div className="container mx-auto px-6 py-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-cream/50">
          <p>© {new Date().getFullYear()} NA WAŁKU Neapolitan Pizza. Wszystkie prawa zastrzeżone.</p>
